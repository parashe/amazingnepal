export const destinationData = [
  ...
  },
  {
  ...
  },
    {
      ...
      overview:
        "The Kathmandu Heritage Tour offers a close-up look at Nepal's rich culture and architectural marvels. This tour takes you to four temples: Kathmandu Durbar Square, Pashupatinath, Boudhanath, and Swayambhunath, all of which are religiously and culturally significant to Nepalese people.",
      itinerary: [
        {
          day: "1st place",
    ...
    },
    {
      ...
      itinerary: [
        ...
        },
        {
          ...
          activitydetails:
            "In this day after breakfast we will visit following sites: - Pashupatinath, Boudhanath, Swayamhbunath, Jalanayan Temple. Overnight in hotel at Kathmandu.",
        },
        {
          day: "Day 3",
          activity: "Drive to Pokhara enroute visit Manokamna Temple",
          activitydetails:
            "After breakfast move to Pokhara, started with a lovely and beautiful scenic tour with and interesting drive on Nepal’s busy main highway. The journey leads past many farm villages and towns with a romantic view of mountains. En-route will visit Manokamana Temple situated in Gorkha district about 90 km west from Kathmandu and east from Pokhara. Manakamana is the Temple of Durga Bhawani, which fulfills the wishes of ones who worship her with a pure heart. After reaching Pokhara, transfer to the hotel near the beautiful Phewa Lake. In the evening walks around the lakeside with the close view of the Annapurna mountain range and stunning peak Machhapuchhre Himal (The Fish Tail). Overnight in hotel at Pokhara.",
        },
        {
          day: "Day 4",
          activity: "Flight from Pokhara to Jomsom and visit Muktinath temple",
          activitydetails:
            "We will transfer to the Pokhara airport for the flight to Jomsom. After arrival at Jomsom airport, you will be picked up and drive to the Muktinath Temple via visiting Kagbeni. Kagbeni is a Tibetan village that is the only “Gateway to, located in the Valley of the Kali Gandaki River. Kagbeni is known as one of the oldest villages in the Himalayas. Muktinath is located at an altitude of 3,710 meters at the foot of the Himalayas – Thorang La mountain pass, Mustang. For both Hindu and Buddhist pilgrims, Muktinath is believed as Mukti kshetra, which means the “place of liberation or moksha”.",
        },
        {
          day: "Day 5",
          activity: "Flight back to Pokhara and sightseeing",
          activitydetails:
            "Morning breakfast at the hotel and depending upon flight time transfer to Jomsom airport for Pokhara flight. Once reached at Pokhara airport transfer to the hotel. And we move for sightseeing like Davis falls, Gupteshwor Cave, Seti River Gorge. In the evening free walk in lakeside around Phewa Lake. Overnight in hotel at Pokhara.",
        },
        {
          day: "Day 6",
          activity: "Drive back to Kathmandu",
          activitydetails:
            "After breakfast, check out of the hotel at Pokhara and drive to Kathmandu. After reaching Kathmandu, get fresh and if you like you can enjoy shopping or explore old Kathmandu city. Overnight at Kathmandu.",
        },
        {
          day: "Day 7",
          activity: "Final Departure",
          activitydetails:
            "For the final departure, our representative will transfer you to the Tribhuvan International Airport.",
        },
      ],
      costIncludes: [
