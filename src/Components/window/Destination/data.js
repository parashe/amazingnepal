export const destinationData = [
  {
    ...
    imageUrl: [
      ...
      {
        id: 2,
        url: "/assets/destination/AnnapurnaRound/annapurna1.jpeg",
      },
      {
        id: 3,
        url: "/assets/destination/AnnapurnaRound/annapurna2.jpeg",
      },
      {
        id: 4,
        url: "/assets/destination/AnnapurnaRound/annapurna3.jpeg",
      },
      {
        id: 5,
    ...
    itinerary: [
      ...
      },
      {
        ...
        activitydetails:
          "The last part of the hike is to the village of Bhojo Gumba. We are at the heart of the Manang district, and this is where the AMS comes into play. We will spend the night there.",
      },
    ],
...

  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        activitydetails:
          "We visit Durbar Square, Pashupatinath Temple, Swayambhunath Stupa, and Bouddhanath Stupa, all of which are World Heritage Sites. In the evening, we introduce ourselves to our fellow participants and discuss our trip to the Everest Base Camp. Overnight in Kathmandu.",
      },
      {
        day: "Day 3",
        activity:
...

  {
    ...
    imageUrl: [
      ...
      {
        id: 5,
        url: "/assets/destination/kathmandu/kathmandu4.jpeg",
      },
      {
        id: 6,
...

  {
    ...
    imageUrl: [
      {
        id: 1,
        url: "/assets/destination/everestgokyo/everest1.jpeg",
        alt: "everest gokyo",
      },
      {
        id: 2,
    ...
    OverviewDescription2: `The walk to the base of the world's highest mountain maps provides breathtaking views of famous landmarks like Gokyo RI and Kala Patthar. The walk also provides us with excellent views of the Khumbu Icefall. Stroll through Gokyo Lakes to Everest Base Camp. In short, it will be an unforgettable experience with breathtaking views of Mt. Cho Oyu Monastery, Everest, Lhotse, Makalu, Nuptse, Amadablam, Pumori, and Tengboche: Nepal's largest monastery. The Gokyo Lakes Trek to Everest Base Camp is ideal for hikers who want to take on more difficult challenges that some people do not dare to attempt.`,

    listofHighlights: [
      "The challenging altitude: Mt. Everest Base Camp (5,364m), Kala Patthar (5,550m), and Chola Pass (5,420m).",
      "Sacred Gokyo Lakes (Longponga Tsho, Taujung Tsho, Gokyo Tsho, Thonak Tsho, Ngozumba Tsho and so on.",
      "A series of six emerald-green, freshwater lakes on the moraine beside Ngozumpa Glacier.",
      "Sunrise view over jaw-dropping mountain vista (including the highest Mt. Everest) from Kala Patthar",
      "Opportunity to view 4 of the 10 highest peaks in the world.",
      "The Khumbu Glacier (world’s highest glacier) and Ngozumpa Glacier (the longest glacier the Himalayas)",
      "The company of majestic mountains, the friendly Sherpas, the colourful monasteries of the Namche Bazaar,",
      "The Sagarmatha National Park and, of course, even the base of the mighty Everest.",
    ],
    itinerary: [
      {
        day: "Day 1",
  ...
  },
  {
    ...
    duration: "22 days",
    available: "Trekking & Hiking",
    OverviewSubHeading: "Makalu Base Camp Trek Some Quick Facts:",
    included:
...

  {
    ...
    imageUrl: [
      {
        id: 1,
        url: "/assets/destination/muktinath/muktinath1.jpeg",
        alt: "Muktinath",
      },
      {
        id: 2,
        url: "/assets/destination/muktinath/muktinath2.jpeg",
        alt: "Muktinath",
      },
      {
        id: 3,
        url: "/assets/destination/muktinath/muktinath3.jpeg",
        alt: "Muktinath",
      },
      {
        id: 4,
        url: "/assets/destination/muktinath/muktinath4.avif",
        alt: "Muktinath",
      },
      {
        id: 5,
        url: "/assets/destination/muktinath/muktinath5.jpeg",
        alt: "Muktinath",
      },
      {
        id: 6,
        url: "/assets/destination/muktinath/muktinath6.jpeg",
        alt: "Muktinath",
      },
      {
        id: 7,
        url: "/assets/destination/muktinath/muktinath7.jpeg",
        alt: "Muktinath",
      },
      {
        id: 8,
        url: "/assets/destination/muktinath/muktinath8.jpeg",
        alt: "Muktinath",
      },
      {
        id: 9,
    ...
    included:
      "All the ground transportation by private vehicle, 2-way flight of Pokhara to Jomsom, Permit and entrance fee as per the itinerary, 3-night hotel in Kathmandu (Taleju Boutique hotel or similar), 2-night hotel in Pokhara (Hotel Lake paradise or similar), 1-night in Jomsom",
    OverviewDescription1: `Kathmandu is the capital city of Nepal. Kathmandu is the center of the Nepal’s history. Among 10 there are altogether seven world heritage sites in Kathmandu valley. Kathmandu is a historic valley and adjoining areas made up a confederation knows as Nepal Mandela which is the ancient civilization of Asia. Kathmandu has greatest concentration of temples, shrines, monasteries. The religious mix of Hindusim, Buddhism, Bon and Shamanism are intoxicating. It is a popular with tourists for unique architecture and rich culture that includes highest number of jatras in Nepal.`,
    OverviewDescription2: `Pokhara is known as the gateway to the Annapurna region, a popular trekking trail in the Himalayas. High above the placid phewa lake there is the peace pagoda. Sarangkot is a spectacular vintage point to watch sunrise and sunset on the Annapurna range. Tibetan refugee camps are located around the town and to the southeast is the narrow ravine of David’s fall. This is the place where you can relish complete recreational activities. You can also shopping in the streets and bazaars of pokhara city by getting spectacular view of the vegetation and the landscape view of city.
 Mustang is located at an altitude of 3,710 meters at the foot of the Himaayas – Thorang La mountain pass, Mustang. For both hindu and Buddhist pilgrims Muktinath is believe as  Mukti kshetra, which means the “place of liberation or moksha”. The central shrine of Mukthinath Temple is considered as one of the eight most sacref shrines for Hindu Vaishnavas known as Svayam Vyakta Kshetras. The major highlights of this muktinath tour is Tatopani, Marpha village Tour (the Apple capital in the nation with Marpha Brandy and Jams produced from local fruits), jomsom, Dhumba lake (lake is fed by ice melt from Mt.Nilgiri), kagbeni, 108 water spouts.
  `,
    listofHighlights: [
      "Weather condition of Muktinath",
      "Best season to visit Muktinath: Autumn (September, October, November)",
      "In spring (March, April, May), enjoy beautiful flora, spectacular mountain views, and moderate weather.",
      "Summer (June, July, August) is less suitable due to heavy rainfall, affecting transportation options.",
      "December, January, February: Trip completion depends on weather and temperature forecasts, with a possibility of snowfall.",
      "Equipment recommendations:",
      "- Autumn: Light jacket, windcheaters, autumn wear.",
      "- Spring: Warm light jackets, windcheaters, light clothes.",
      "- Summer: Light windcheaters, jackets, summer wear, raincoat.",
      "- Winter: Heavy down jackets, winter wear for cold weather.",
      "Mustang's inhabitants, of Tibetan and Thakali origin, celebrate festivals like Tiji, Lhosar, Duk Chu.",
      "Mustang is famous for Thakali food, local wines, apples, Tibetan bread, Marpha, and dried food.",
    ],
    itinerary: [
      {
        day: "Day 1",
        activity: "Kathmandu arrival",
        activitydetails:
          "On arrival at Tribhuvan International Airport in Kathmandu, our representative will greet and receive you at the airport. Then transfer to your hotel. After reaching your hotel, check in and take rest. Free in the evening. Overnight in hotel at Kathmandu.",
      },
      {
        day: "Day 2",
        activity: "Full day Kathmandu sightseeing",
        activitydetails:
          "After breakfast, embark on a full-day sightseeing tour of Kathmandu. Visit Pashupatinath, Boudhanath, Swayamhbunath, and Jalanayan Temple. Overnight in hotel at Kathmandu.",
      },
      {
        day: "Day 3",
        activity: "Drive to Pokhara enroute visit Manokamna Temple",
        activitydetails:
          "After breakfast, drive to Pokhara. En-route, visit Manokamna Temple in Gorkha district. Upon reaching Pokhara, transfer to a hotel near Phewa Lake. Enjoy an evening stroll around the lakeside. Overnight in hotel at Pokhara.",
      },
      {
        day: "Day 4",
        activity: "Flight from Pokhara to Jomsom and visit Muktinath temple",
        activitydetails:
          "Transfer to Pokhara airport for a flight to Jomsom. Upon arrival, drive to Muktinath Temple via Kagbeni. Explore the sacred site and its surroundings. Overnight in Jomsom.",
      },
      {
        day: "Day 5",
        activity: "Flight back to Pokhara and sightseeing",
        activitydetails:
          "After breakfast, fly back to Pokhara. Proceed for sightseeing at Davis falls, Gupteshwor Cave, and Seti River Gorge. Enjoy a leisurely evening walk around Phewa Lake. Overnight in hotel at Pokhara.",
      },
      {
        day: "Day 6",
        activity: "Drive back to Kathmandu",
        activitydetails:
          "Check out from the hotel in Pokhara after breakfast and drive back to Kathmandu. Enjoy shopping or explore the old city upon arrival. Overnight at Kathmandu.",
      },
      {
        day: "Day 7",
        activity: "Final Departure",
        activitydetails:
          "Our representative will transfer you to Tribhuvan International Airport for your departure.",
      },
    ],
    priceIncludes: [
  ...
  },
  {
    ...
    imageUrl: [
      ...
      {
        id: 2,
        url: "/assets/destination/manaslu/manaslu2.jpg",
        alt: "manaslu circuit Trek",
      },
      {
        id: 3,
        url: "/assets/destination/manaslu/manaslu3.jpeg",
        alt: "manaslu circuit Trek",
      },
      {
        id: 4,
    ...
    listofHighlights: [
      "Stunning natural beauty of the forests, rivers, and flora of the Manaslu region.",
      "Rich culture of the region, including Nepalese and Tibetan ethnic groups.",
      "Larky La Pass (5167 meters), the highest point of the trek.",
      "Breathtaking views of Manaslu, Cheo Himal, Himalung Himal, Nemjung, Gyaji Kang, Kang Guru, and Annapurna II.",
      "Abundant wildlife including Tahr (mountain goat), Agali (blue sheep), pika, Himalayan marmots, and if lucky, Snow Leopard.",
      "Scenic walk through the Budi Gandaki valley.",
    ],
    itinerary: [
      {
        day: "Day 1",
    ...
    priceIncludes: [
      "All arrival and departure transfer in private vehicle",
      "3 star hotel in Kathmandu and during trekking will be local tea house/ guests house",
      "All meals (lunch and dinner) as described in itinerary",
      "A private vehicle as per group size",
    ...
    usefulInformation: [
      ...
      "The Manaslu Circuit Trek is known for its unique blend of Tibetan and Nepalese culture.",
      "The Manaslu Circuit is open from March to June and September to November",
      "The region is extremely rich in wildlife, adding to the adventure of the journey",
      "The Manaslu Circuit trek is a challenging journey in Nepal's northwestern region",
...

  {
    ...
    imageUrl: [
      {
        id: 1,
        url: "/assets/destination/ghorepani/ghorepani1.jpeg",
        alt: "ghorepani",
      },
      {
        id: 2,
        url: "/assets/destination/ghorepani/ghorepani2.jpeg",
        alt: "ghorepani",
      },
      {
        id: 3,
        url: "/assets/destination/ghorepani/ghorepani3.jpeg",
        alt: "ghorepani",
      },
      {
        id: 4,
        url: "/assets/destination/ghorepani/ghorepani4.jpeg",
        alt: "ghorepani",
      },
      {
        id: 5,
        url: "/assets/destination/ghorepani/ghorepani5.jpeg",
        alt: "ghorepani",
      },
      {
        id: 6,
    ...
    OverviewSubHeading: "Overview",
    OverviewDescription1: `One of the most exciting and impressive treks is the Ghorepani Poon Hill Trek. The evergreen trekking route leads you through beautiful historic ethnic villages and world-class mountain scenery. Poon Hill's gentle trekking fulfills your dream of seeing snow-capped peaks and marveling at the Himalayan subculture that offers a once-in-a-lifetime experience. It is a magnificent retreat that combines the incredible beauty of nature with the flavor of the unique local culture, making your trip so healthy. From Kyumi, the road follows Modi Khola and leads to Ghandruk, which is also connected to Nayapul.
    Ghandruk is a large and beautiful village with stunning views of Annapurna's southern summit towards Tadapani and then west to Ghorepani. The path preserves mosaic valleys, dense mosses, and icy waterfalls. It also has beautiful mountain villages, brilliant rhododendron forests, and a diverse range of ethnic groups and cultures. This excellent all-around component elevates the trekking experience in Nepal.
    `,
    OverViewDescription2: `The warmth of the region's inhabitants, combined with the beautiful landscapes that can be seen from Poon Hill, a small colorful village that also serves as a point of view window located in the Annapurna Conservation Area at an elevation of 3,210 m; it's more than you bargained for. The breathtaking view of the top of the fishtail [Machhapuchre] and the Modikhola River is breathtaking. There are marked hiking trails nearby, impressive mountains to see, fish to catch, and beautiful rare birds to see; this is what you live on this trip. The beautiful rhododendrons, sunrises, and sunsets are also a welcome addition to this trip. It's fantastic wherever you go. Ghorepani Poon Hill Trek is time-appropriate, and you can enjoy this wonderful trekking trip in Nepal.`,
    ...
    itinerary: [
      ...
      { day: "Drive from Kathmandu to Pokhara" },
