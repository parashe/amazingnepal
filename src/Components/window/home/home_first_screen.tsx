  ...
  return (
    <>
      <div className="w-full h-full flex flex-col items-center">
        ...
        />
        <div className="w-full flex sm:bottom-[-50px]  sm:absolute justify-center">
          <ContentCard
...
export const HomeTopContent = ({
  ...
  return (
    <div className="w-full flex justify-center items-center ">
      {/* Image */}
      <img
        className="w-full  object-fill h-60 md:h-[500px] brightness-75 transition duration-500 ease-in-out transform hover:scale-105"
        src={imageUrl}
        alt=""
        loading="lazy"
      />
...
const ContentCard: React.FC<ContentCardProps> = ({
  ...
  return (
    <div className="flex flex-row container mx-auto justify-center items-center w-full bg-gradient-to-r from-blue-400 via-red-400 to-pink-500 min-h-[200px] shadow-xl p-8  relative text-white">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-center items-center flex-wrap md:flex-nowrap gap-6">
          <img
            ...
            className="w-24 h-24 rounded-full mb-3 animate-pulse object-cover "
          />
...
const Search: React.FC<SearchProps> = ({
  ...
  return (
    <div className="w-full">
      <form className="min-w-[350px] sm:min-w-[400px] md:min-w-[500px] mx-auto">
        <div className="relative">
          <input
            type="search"
            autoComplete="off"
            id="default-search"
            className="block w-full border border-gray-300 p-3 ps-10 text-lg text-gray-900 rounded-full bg-white focus:ring-2 focus:ring-pink-500"
